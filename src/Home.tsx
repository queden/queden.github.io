    ...
    <div className="home">
      <div className={`intro ${props.theme}`}>
        ...
        <p>
          ...
          affordable housing for all, spirituality, fintech and blockchain. I know very little about all of these things, and would love to learn from you if you do.
        </p>
        <p>
